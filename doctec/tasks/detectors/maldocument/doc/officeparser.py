...
class CompoundBinaryFile:
    def __init__(self, file, parser_options=None):
        ...
        sig = self.f.read(8)    # b'\xd0\xcf\x11\xe0\xa1\xb1\x1a\xe1'
        is_ole_document = sig == OLE_SIGNATURE.encode('latin-1')
        ...
        # load the header
        # print("header:",self.f.read(512))
        # header: b'\xd0\xcf\x11\xe0\xa1\xb1\x1a\xe1\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00>\x00\x03\x00\xfe\xff\t'

        self.header = Header(self.f.read(512), parser_options)
        self.sector_size = 2 ** self.header._uSectorShift   # 512

        self.mini_sector_size = 2 ** self.header._uMiniSectorShift  #64

        # get a sector count
        if (os.path.getsize(file) - 512) % self.sector_size != 0:
            logging.warning("last sector has invalid size")

        self.sector_count = int((os.path.getsize(file) - 512) / self.sector_size)   #19
        ...
        for fat_sect in self.fat_sectors:
            ...
            if len(data) != self.sector_size:
                ...
                format_str = '<{0}L'.format(int(self.sector_size / 4))   # <128L

                for value in unpack(format_str, data):
